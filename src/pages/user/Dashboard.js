            ...
            <section className="p-6 bg-gray-200 rounded-xl shadow-xl">
                ...
                <div id="feedbackModal" className="hidden fixed inset-0 bg-black/10 backdrop-blur-lg flex items-center justify-center z-50">
                    <div className="bg-white border border-white/30 w-full max-w-lg p-6 rounded-2xl shadow-2xl relative animate-fadeIn">
                        ...
                        <h2 className="text-2xl font-bold mb-4 text-black">We value your feedback</h2>
                        ...
                        <form className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex space-x-2" id="star">
                                    <button onClick={() => star(1)} type="button" className="w-10 h-10 flex items-center justify-center border border-black/30 bg-white/10 rounded-full text-yellow-300 hover:bg-yellow-400 hover:text-white">⭐</button>
                                    <button onClick={() => star(2)} type="button" className="w-10 h-10 flex items-center justify-center border border-black/30 bg-white/10 rounded-full text-yellow-300 hover:bg-yellow-400 hover:text-white">⭐</button>
                                    <button onClick={() => star(3)} type="button" className="w-10 h-10 flex items-center justify-center border border-black/30 bg-white/10 rounded-full text-yellow-300 hover:bg-yellow-400 hover:text-white">⭐</button>
                                    <button onClick={() => star(4)} type="button" className="w-10 h-10 flex items-center justify-center border border-black/30 bg-white/10 rounded-full text-yellow-300 hover:bg-yellow-400 hover:text-white">⭐</button>
                                    <button onClick={() => star(5)} type="button" className="w-10 h-10 flex items-center justify-center border border-black/30 bg-white/10 rounded-full text-yellow-300 hover:bg-yellow-400 hover:text-white">⭐</button>
                                </div>
                            </div>
                            <div className="text-right">
                                <button type="button" onClick={saveFeedback} className="px-6 py-2 bg-indigo-600/80 text-white rounded-lg shadow-lg hover:bg-indigo-700 transition">Submit Feedback</button>
                            </div>
                        </form>
                    </div>
                </div>
