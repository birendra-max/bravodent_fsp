                ...
                <section className="py-8">
                    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <motion.div
                            ...
                            className={`rounded-xl shadow-lg mb-8 ${theme === "light" ? "bg-gray-200 border-gray-200" : "bg-gray-800 border-gray-700"}`}
                        >
                            <div className="p-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                            ...
                            <motion.div
                                ...
                                className={`rounded-xl shadow-lg flex flex-col ${theme === "light" ? "bg-gray-200 border-gray-200" : "bg-gray-800 border-gray-700"}`}
                            >
...
/* 🔹 Subcomponents - Removed unused components since we changed layout */